...
public class EmergencyApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_app);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(EmergencyApp.this, Category.class);
                startActivity(i);
                finish();
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emergency.put("Name", name);
                emergency.put("Loan", ln);
                emergency.put("Montlhy", montP);
                emergency.put("Months", months);
                emergency.put("Interest", interes);
                emergency.put("Total", amor);
                ...
                db.collection("emergency")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                Toast.makeText(EmergencyApp.this, "Data Stored Successfully",Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(EmergencyApp.this, "Data Not Stored",Toast.LENGTH_SHORT).show();
                            }
                        });
